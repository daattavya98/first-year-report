...
\begin{table}[ht]
    ...
    \end{table}
The number theoretic conjectures are based on input type (i) of our setup where both a domain $\Omega$ and function box $\mathcal{F}$ are provided.
...
\begin{remark}
    ...
    finding heuristics for interestingness and being able to classify conjectures. The utility of this implementation can be seen through a variety of applications I have been working on \ref{chap:applications}. Previously this approach has been succesful in reproducing well-known conjectures (such as Hardy-Littlewood's second conjecture \cite{mishraConjGen2023}) and new results involving finite simple groups \cite{heLearningBeSimple2023}.
\end{remark}
