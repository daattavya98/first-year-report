...
The second aspect is the \textit{surprisingness} of a conjecture. As described by \citeauthor{bengioMachineLearningInformation2024} in \cite{bengioMachineLearningInformation2024}, a possible implementation of surprisal is the following:
...
\par I am interested in exploring a number of other heuristics to estimate the utility of a conjecture and the likelihood of its truth. Connexions with the theorem space \ref{sec:theorem-spaces} are a promising avenue for these properties in particular. However, the major insights for `interestingness' heuristics are likely to arise by making observations while working on specific applications. The choice of applications made in chapter \ref{chap:applications} is motivated by this goal. By making progress in these projects, we are hopeful to abstract our learning as meta-mathematical tools.
...
talk about information content, entropy stuff here. Include what the issue with entropy directly is. Also connect to other ideas of interestingness I am exploring/have thought about atleast.
