...
Updating the implementation in section \ref{sec:basic-setup} to be more efficient and scale when working with larger amounts of data. Also aim to include these heuristics in the symbolic implementation (section \ref{sec:symbolic-implement}). The tangible goal is to publish this pipeline as a package and make it accessible to the community.

\section{Multi-agent based math discovery}
