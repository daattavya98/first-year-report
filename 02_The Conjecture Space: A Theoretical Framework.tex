...
\begin{table}[ht]
        ...
        \begin{tabular}{|c|c|}
            ...
            \hline
            Algebraic Geometry & \makecell{dim 3: $5d_1 + 4d_2 + 4d_3 > 8$ \\ dim 4: $6d_2 + 4d_3 + 15d_4 > 4d_1 + 2$}\\
            \hline
        \end{tabular}
...
The algebraic geometry conjectures are based on input type (ii). Given a \textit{lattice polytope}\begin{footnote}[1]{Let $N\cong\mathbb{Z}^d$ be a lattice of rank $d$ and let $N_\R := N\otimes_{\mathbb{Z}}\R\cong\R^d$. A convex Polytope $P\subset N_\R$ is a \textit{lattice polytope} if its vertices are all elements of $N$}.\\ 
